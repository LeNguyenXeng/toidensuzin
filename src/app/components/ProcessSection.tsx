...
import toidenImage from "../../images/toiden.jpg";
...
const processSteps = [
  {
    ...
    description:
      "Tỏi tươi nguyên liệu được chọn lọc kỹ càng từ vùng trồng sạch",
  },
  {
    icon: ThermometerSun,
  ...
  {
    icon: Timer,
    title: "Lên Men 45 Ngày",
    description:
      "Quy trình lên men tự nhiên kéo dài 45 ngày để tạo hương vị độc đáo",
  },
  {
    icon: CheckCircle,
...
export function ProcessSection() {
  return (
    <section
      id="process"
      className="scroll-mt-24 py-14 lg:py-20 bg-gradient-to-b from-[#faf9f7] to-white relative overflow-hidden"
    >
          ...
          <div className="space-y-6">
            ...
            >
              <p className="text-gray-700 leading-relaxed">
                <span className="text-[#D4AF37]">✓</span> Được chứng nhận an
                toàn thực phẩm và đạt tiêu chuẩn quốc tế
              </p>
            </motion.div>
          </div>
        </div>
